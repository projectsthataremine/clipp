...
const FILES_TO_UPLOAD = [
  `Clipp-${VERSION}-arm64-mac.zip`,
  `Clipp-${VERSION}-arm64-mac.zip.blockmap`,
  `Clipp-${VERSION}-arm64.dmg`,
  `Clipp-${VERSION}-arm64.dmg.blockmap`,
];
...
async function main() {
  ...
  console.log(`\n📦 Publishing Clipp ${VERSION} to GitHub`);
