        ...
        >
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="hidden md:inline-flex items-center gap-2 px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-colors text-lg"
            >
